# From Autodesk: https://help.autodesk.com/view/fusion360/ENU/?guid=GUID-5a4fa3a6-fa21-11e4-b610-f8b156d7cd97
# Description: Traverses the current assembly, creates a tree of all the occurrences and writes the output to the Text Commands window.
